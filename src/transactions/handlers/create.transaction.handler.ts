...
export class CreateTransactionRequest {
  @ApiProperty({
    description:
      'The amount of the transaction. Must be an unsigned integer value',
    example: 100,
  })
  @IsInt()
  amount: number;
...
export type AuthenticatedCreateRequest = AuthenticatedRequest &
  IdempotentRequest & { accountId: string; data: CreateTransactionRequest };
...
export class TransactionResponse {
  ...
  @ApiProperty({
    description:
      'The amount of the transactionansa. Must be an unsigned integer value',
    example: 100,
  })
  @IsInt()
  amount: number;
...
export function mapTransactionEntity(
