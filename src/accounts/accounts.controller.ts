...
import {
  ...
  AccountResponse,
} from './handlers/create.account.handler';
import {
  ListAccountHandler,
  ListAccountResponse,
} from './handlers/list.account.handler';
import {
...
import {
  PatchAccountHandler,
  PatchAccountRequest,
} from './handlers/patch.account.handler';
...
export class AccountsController {
  ...
  @ApiConflictResponse({
    description: 'Account with generated details already exists',
  ...
  async patchAccount(
    ...
    return this.patchAccountHandler.handle({
      userId: user.uuid,
      accountId,
      data: body,
    });
